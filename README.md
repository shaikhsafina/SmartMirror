...
<img width="1200" height="1600" alt="image" src="https://github.com/user-attachments/assets/c5dba79a-2297-4e37-8e7d-ef9d15385f37" />
...
6.2 CONFIG THE PI
  ...
  Then Add unclutter -idle 0.1 -root to /etc/xdg/lxsession/LXD-pi/autostart with 
...
6.3 CONFIGURE SOUND
  ...
  Should you want to change the output from AUX (headphone jack) to HDMI or back again you can runt he following:
...
From the command line 
  ...
  If you're not running the mirror for the first time and you've properly configured the Sound and Voice, say the keyword/hotword and the "Show Remote Link" to display the URL to reach the Remote Configuration Tool.
...
<img width="1280" height="513" alt="image" src="https://github.com/user-attachments/assets/38468034-1cda-41c2-9669-5132dd1c445c" />
...
<img width="1280" height="384" alt="image" src="https://github.com/user-attachments/assets/13acb6a0-ea7d-42e6-b486-e7cb7adc1f22" />
...
<img width="1600" height="204" alt="image" src="https://github.com/user-attachments/assets/80617a74-77f4-4c8d-8f4d-b32072392111" />
...
<img width="1600" height="204" alt="image" src="https://github.com/user-attachments/assets/032ba598-a35f-45a3-9fd7-7710fd32f8e3" />
...
<img width="1600" height="204" alt="image" src="https://github.com/user-attachments/assets/63eb1d31-dda1-4b42-9c8d-ca3a27cdba27" />

#
  Multi-line compliments:
  
   Use \n to split compliment text into multiple lines, e.g. First line.\n.Second line. Will be shown as :
<img width="1600" height="204" alt="image" src="https://github.com/user-attachments/assets/a710198d-2f80-4e25-841f-10b74da328c3" />
...
<img width="1600" height="204" alt="image" src="https://github.com/user-attachments/assets/aba958f6-264d-4a0b-932f-accd50526706" />
...
<img width="1600" height="204" alt="image" src="https://github.com/user-attachments/assets/10cfdb2f-7172-4308-87e8-a7feccb5885a" />
...
#
Notification sent by the module
...
Option
      ...
      endTags
        Description - List the tags you would like to have removed at the end of the feed item
                      Possible values: ['TAG'] OR ['TAG','TAG2',...]
      prohibitedWords
        Description - Remove news feed item if one of these words is found anywhere in the title (case insensitive and greedy matching)
                      Possible values: ['word'] or ['word1','word2',...]
      scrollLength
        Description - Scrolls the full news article page by given number of pixels when a ARTICLE_MORE_DETAILS notification is received and the full news article                       is already displayed.
                      Possible values: 1 or 10000
                      Default value: 500
      logFeedWarnings
        Description - Log warnings when there is an error parsing a news article.
                      Possible values: true or false
                      Default value: false
The feeds property contains an array with multiple objects. These objects have the following properties:
  ...
  Options
      ...
      title 
        Description - The name of the feed source to be displayed above the news items.
                      This property is optional.
      url
        Description - The url of the feed used for the headlines.
                      Example: 'https://www.nytimes.com/services/xml/rss/nyt/HomePage.xml'
      encoding
        Description - The encoding of the news feed.
                      This property is optional.
                      Possible values: 'UTF-8', 'ISO-8859',etc...
                      Default value: 'UTF-8'
      useCorseProxy
        Description - Uses the internal cors proxy to avoid cors errors.
                      This property is optional.
                      Possible values: true or false
                      Default value: true

7.6.6 UPDATE NOTIFICATION

  The updatenotification module is one of the default modules of the Smart Mirror. This will display a message whenever a new version of the Smart Mirror application is available.
...
To use this module, add it to the modules array in the config/config.js file:
      ...
      { 
          : "updatenotification",
            : "top_center", // This can be any of the regions.
          : {
            // The cofig property is optional.
            // See 'Configuration options' for more information.
            },
          },
        };
<img width="1600" height="204" alt="image" src="https://github.com/user-attachments/assets/4eeac216-bd8a-4ed2-af8a-ba9e74332b69" />
...
Options
        ...
        updateInterval
          Description - How often do you want to check for a new version? This value represents the interval in milliseconds.
                        Possible values: Any value above 60000 (1 minute)
                        Default value: 600000 (10 minutes);
        ignoreModules
          Description - An array of module names that should not check for update.
                        Example: ["MMM-ExampleModule1",
                        "MMM-ExampleModule2"]. You can exclude Smart Mirror by adding "Smart Mirror" to the array.
                        Default value: [] (empty array, no modules);
7.7.7 weather module
  ...
  The module is in a very early stage, and needs a lot of work. It's API isn't se tin stone, so keep that in mind when you want to contribute.

#
  Example
  
<img width="1200" height="1600" alt="image" src="https://github.com/user-attachments/assets/d484f638-5cc3-4961-adfc-24176532d2b1" />

# 
  USAGE 

 To use this module, add it to the modules array in the config/cofnig.js file:
...
<img width="1600" height="204" alt="image" src="https://github.com/user-attachments/assets/e3bd6e4e-e780-4020-9cdd-bc2559677d2d" />
...
Options 
        ...
        weatherProvider
          Descriptions - Which weather provider should be used.
                         Possible values: openweathermap, pirateweather, weathergov, ukmetofficedatahub, ukmetoffice, weatherbit, envcanada, openmeteo or yr
                         Default value: openweathermap
        type
          Description - Which type of weather data should be displayed.
                        ...
                        - Yr (yr)
        units
          Description - What units to use. Specified by config.js
                        Possible values: config.units = Specified by config.js, metric = Celsius, imperial = Fahrenheit
                        Default value: config.units
        tempUnits
          Description - What units to use for temperature. If not specified, the module uses the units value from config.js.
                        Possible values: config.units = Specified by config.js, metric = Celsius, imperial = Fahrenheit
                        Default value: config.units
        windUnits
          Description - What units to use for wind speed. If not specified, the module uses the units value from config.js.
                        Possible values: config.units = Specified by config.js, mps or metric = meters per second, kmh = kilometres per hour, mph or inperial =                           miles per hours, beaufort = use beaufort scale, knots = show wind in knots
                        Default value: units
        roundTemp
          Description - Round temperature value to nearest integer.
                        Possible values: true (roud to integer) or false (display exact value with decimal point)
                        Default value: false
        degreeLabel
          Description - Show the degree label for your chosen units (Metric = C, Imperial = F).
                        Possible values: true or false
                        Default value: false
        updateInterval
          Description - How often does the content needs to be fetched? (Milliseconds)
        ...
        timeFormat
          Description - Use 12 or 24 hour format.
                        Possible values: 12 or 24
                        Default value: uses value of config.timeFormat
        showPeriod
          Description - Show the Period (am/pm) with 12 hour format
        ...
        showPrecipitationAmount
          Description - Show the amount of rain/snow.
...
Amazon.com. Raspberry Pi 3 Model B Motherboard: Computers & Accessories", 2017. [Online]. Available: https://www.amazon.com/Raspberry-Pi-RASPBERRYPI3-MODB-1GB-Model-Motherboard/dp/B01CD5VC92/
    
ref=sr_1_3?ie=UTF8&qid=1490491421&sr=8-3&keywords=raspberry+pi+3+model+b
    
www.raspberrypi.com
    
raspberrypi.stackexchange.com

https://www.raspberrypi.com/documentation/computers/configuration.html#the-respi-config-command-line-interface

https://Smart Mirror.builders/

www.youtube.com

https://www.ijert.org/smart-mirror-2
